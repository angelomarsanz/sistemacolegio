<div class="row">
    <div class="col-md-12">
		<div class="page-header">
            <?= $this->Html->link('Lista de calificaciones descriptivas de materia', ['action' => 'index'], ['class' => 'btn btn-sm btn-default']); ?>
	        <h3>Agregar calificación descriptiva de materia</h3>
	    </div>
    </div>
</div>
    ...
    <fieldset>
        <div class="row">
            <div class="col-md-4">
                ...
                echo $this->Form->input('materia_id', ['label' => 'Materia: *', 'options' => $materias, 'value' => $idMateria, 'required']);
                echo $this->Form->input('student_id', ['label' => 'Estudiante: *', 'options' => $estudiantes, 'value' => $idEstudiante, 'required']);
                echo $this->Form->input('tipo_observacion', ['label' => 'Dimensión o rasgo de personalidad: *', 'required']);

                echo $this->Form->input('tipo_observacion', ['label' => 'Literal asignado a la dimensión o rasgo de personalidad: *', 'options' => ['A' => 'A', 'B' => 'B', 'C' => 'C'], 'required']); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
