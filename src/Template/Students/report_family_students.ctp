				...
				<?php if ($accountRecords == 0): ?>
					...
					<table id="family-students" name="family_students" class="table noverScreen">
						<thead>
							...
							<tr>
								<th></th>
								<th><b>Fundación Colegio Verdad y Libertad</b></th>
							</tr>
							<?php if ($orderReport == "Representante"): ?>
								<tr>
									<th></th>
									<th><b>Representantes y Alumnos</b></th>
								</tr>
							<?php else: ?>
								<tr>
									<th></th>
							...
							<?php if ($orderReport == "Representante"): ?>
								<tr>
									<th></th>
									<th><b>Detalle de representantes y alumnos</b></th>
								</tr>	
							<?php else: ?>
								<tr>
									<th></th>
