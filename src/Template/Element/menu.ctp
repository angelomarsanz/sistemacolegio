					...
					<?php if($current_user['role'] == 'Administrador'): ?>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li><?= $this->Html->link('Cobranza', ['controller' => 'Turns', 'action' => 'checkTurnInvoice', 'Mensualidades']) ?></li> 
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">    
								...
								<li><?= $this->Html->link('Reporte excel representantes y alumnos', ['controller' => 'Students', 'action' => 'familyStudents']) ?></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">    
								...
								<li><?= $this->Html->link('Alumnos inscritos a partir de septiembre', ['controller' => 'Students', 'action' => 'reporteInscritosConFactura']) ?></li>
								...
								<li><?= $this->Html->link('Asignar descuento', ['controller' => 'Students', 'action' => 'becasEspeciales']) ?></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">    
								...
								<li><?= $this->Html->link('Resumen mensual de contabilidad', ['controller' => 'Turns', 'action' => 'resumenMensualContabilidadPrevio']) ?></li>
