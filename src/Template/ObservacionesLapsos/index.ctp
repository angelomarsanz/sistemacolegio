<div class="row">
    <div class="col-md-12">
        <div class="page-header">
            <?= $this->Html->link('Agregar nueva calificación descriptiva de lapso', ['action' => 'add'], ['class' => 'btn btn-sm btn-default']); ?>
        ...
        <div>
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th scope="col">Dimensión o tipo de calificación&nbsp;&nbsp;&nbsp;</th>
