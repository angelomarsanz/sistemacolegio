						...
						<div class="col-md-12">					
							<table>
								<thead>
									...
									<tr>
										<th style="font-size: 14px; line-height: 16px;"><b><?= 'Pago de Matrícula '.$schools->current_shools_year ?></b></th>
									</tr>
								</thead>
							</table>
						</div>
							...
							<table class="table table-striped table-hover">
								...
								<tbody>				
									...
									foreach ($soloFacturas as $factura):
										if (substr($factura->school_year, 0, 12) == $schools->current_shools_year):
											foreach ($vectorConceptos as $concepto):
												if ($concepto['idFactura'] == $factura->id):
													if ($concepto['concepto'] == 'Matrícula '.$schools->current_shools_year): 
						...
						<div class="col-md-12">					
							<table>
								<thead>
									...
									<tr>
										<th style="font-size: 14px; line-height: 16px;"><b><?= 'Pago de Mensualidades '.$schools->current_shools_year ?></b></th>
									</tr>
								</thead>
							</table>
						</div>
