...
<div class="container">
	<div class="jumbotron">
    	<h1>Bienvenidos al Sistema del Colegio Verdad y Libertad !</h1>
    	<p>Por favor escriba en el campo usuario, el número de cédula del representante sin puntos. Ejemplo: V10347134. Después escriba la contraseña y pulse el botón Acceder</p>
	</div>
