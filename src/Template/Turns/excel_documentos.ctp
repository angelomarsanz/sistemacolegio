							...
							<table name="excel_documentos" id="excel-documentos" class="table table-striped table-hover">
								<thead>
									<tr>
										...
										<th style="text-align: center;">Tasa P</th>
										...
										<th style="text-align: center;">Trans P</th>
										<th style="text-align: center;">Trans Bs.</th>
								...
								<tbody>				
									<?php foreach ($vectorPagos as $pago): ?>
										<tr>
											...
											<?php $compensado = round($pago['ncNdDolar'] * $pago['tasaDolar'], 2); ?>
