<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $parametrosCargaCalificacion->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $parametrosCargaCalificacion->id)]
            )
        ?></li>
...
<div class="parametrosCargaCalificacions form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Parametros Carga Calificacion') ?></legend>
        <?php
