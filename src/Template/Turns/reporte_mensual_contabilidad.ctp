...
<div name="reporte_cierre" id="reporte-mensual-contabilidad" class="container" style="font-size: 12px; line-height: 14px;">
	<br />
    <div class="row">
        <div class="col-md-12">
			<div>
				<table style="width:100%; font-size: 14px; line-height: 16px;">
					<tbody>
						...
						<tr>
							<td><b>Resumen de contabilidad correspondiente al mes de <?= $turn->turn ?></b></td>
						</tr>
					</tbody>
				</table>
			</div>
