			...
			<div id="contadores" style="font-size: 10px; line-height: 12px;">
				<div>
					<table style="width:100%; font-size: 14px; line-height: 16px;">
						<tbody>
							<tr>
								<td>Fundación Unidad Educativa</td>
							</tr>
							<tr>
								...
								<table class="table table-striped table-hover">
									<thead>	
										<tr>
											...
											<th style="text-align: center;"><b>Efvo P</b></th>
						...
						<div class="row">
							<div class="col-md-12">					
								<table class="table table-striped table-hover">
									<thead>
										<tr>
											<th style="text-align: center;"><b>Representante</b></th>
											...
											<th style="text-align: center;"><b>E P</b></th>
									...
									<table class="table table-striped table-hover">
										<thead>
											<tr>
												...
												<th style="text-align: center;"><b>Monto P</b></th>
